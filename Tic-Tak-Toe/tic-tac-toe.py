...
lbl = Label(window, text = "Tic-Tac-Toe", font = ('Helvatica', '20'))
lbl.grid(row = 0, column = 0)
lbl = Label(window, text = "Player 1 : X", font = ('Helvatica', '14'))
lbl.grid(row = 1, column = 0)
lbl = Label(window, text = "Player 2 : O", font = ('Helvatica', '14'))
lbl.grid(row = 2, column = 0)

turn = 1 # for first person to start the game
